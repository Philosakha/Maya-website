   ...
   <>
    <div className='text-white'>
        <div className='max-w-[800px] mt[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center items-center '>
            <p className='p-2'>Best way to build on mina</p>
            <h1 className='md:text-6xl sm:text-5xl text-4xl font-bold md:py-6'>The Gateway to Lightest Blockchain</h1>
           
                <div className='flex justify-center items-center py-4'>
                    <p className='pt-2 md:text-4xl sm:text-xl text-l font-bold'>ZK with Everything </p>
